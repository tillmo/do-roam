...
#    icon("Strom_aus_regenerativen_Energien","fuelpump.png")
  ...
  icon("Minigolf","question-mark.png")
  icon("Ruins","question-mark.png")
  ...
  icon("Forests","question-mark.png")
  icon("Climbing","question-mark.png")
  icon("Computer","question-mark.png")
  icon("Tourism","question-mark.png")
  icon("Massage","question-mark.png")
  icon("Soccer","question-mark.png")
  icon("Hiking","question-mark.png")
  icon("Bakery","question-mark.png")
  icon("PlacesOfWorship","question-mark.png")
  icon("Greek","restaurant.png")
  icon("Dance","question-mark.png")
  icon("GolfCourses","question-mark.png")
  icon("Opticians","question-mark.png")
  icon("Valleys","question-mark.png")
  icon("Castles","question-mark.png")
  icon("Rivers","question-mark.png")
  icon("Finance","question-mark.png")
  icon("TravelAgencies","question-mark.png")
  icon("FitnessStudio","question-mark.png")
  icon("InformationService","question-mark.png")
  icon("Bowling","question-mark.png")
